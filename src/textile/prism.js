/* PrismJS 1.30.0
https://prismjs.com/download#themes=prism&languages=markup+css+clike+javascript+batch+c+cpp+go+javadoclike+jsdoc+json+less+makefile+markdown+jsx+tsx+regex+textile+toml+typescript+typoscript+web-idl+yaml */
var _self =
